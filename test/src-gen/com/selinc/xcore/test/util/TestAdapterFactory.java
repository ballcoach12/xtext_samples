...
public class TestAdapterFactory extends AdapterFactoryImpl {
	...
	protected TestSwitch<Adapter> modelSwitch =
		new TestSwitch<Adapter>() {
			@Override
			public Adapter caseBob(Bob object) {
				return createBobAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link com.selinc.xcore.test.Bob <em>Bob</em>}'.
	 * <!-- begin-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createBobAdapter() {
		return null;
	}
